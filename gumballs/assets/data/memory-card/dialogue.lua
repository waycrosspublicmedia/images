local dialogues = {
    {text = "siigh.. well, that was a fun Adventure, was it not my beautiful partener?", char = "bf", side = "right", speed = 0.035},
    {text = "yeam :)", char = "gf", side = "middle", speed = 0.03},
    {text = "all this adventuring.. makes me want to play some good old Sonic's Adventures!", char = "bf", side = "right", speed = 0.03},
    {text = "can i watch pleaase", char = "gf", side = "middle", speed = 0.03},
    {text = "okay!", char = "bf", side = "right", speed = 0.03},
    {text = "Hey hey hey, it's world famous hedhehog. Sonic the Hedgehog!", char = "sonic", side = "left", speed = 0.03},
    {text = "Whoa the Fuck?", char = "gf", side = "middle", speed = 0.03},
    {text = "i love tou ssonic", char = "bf", side = "right", speed = 0.03},
    {text = "it's me Sonic !", char = "sonic", side = "left", speed = 0.03},
    {text = "composed by randominc", char = "bf", side = "right", speed = 0.03},
}
...
function onCreatePost()
    ...
    addAnimationByPrefix('char', 'sonic', 'sonic', 24, false)
