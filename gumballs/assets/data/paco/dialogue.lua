local dialogues = {
    {text = "ohh man im gonna ahve to kill you bro sorry...", char = "pico", side = "guy", speed = 0.035},
    {text = "noo cmon we used to be friends...\nmore than friends.....", char = "bf", side = "right", speed = 0.035},
    {text = "im sorry babygirl i was hired", char = "pico", side = "guy", speed = 0.035},
    {text = "hey now... why dn't you two just rap it out", char = "gf", side = "middle", speed = 0.035},
    {text = "my boo is right lets rap like ol times", char = "bf", side = "right", speed = 0.035},
    {text = "okay baby", char = "pico", side = "guy", speed = 0.035}
}
...
function onCreatePost()
    ...
    addAnimationByPrefix('char', 'pico', 'pico', 24, false)
