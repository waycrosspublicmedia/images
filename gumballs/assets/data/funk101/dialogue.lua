local dialogues = {
    {text = "wow your ex is kinda scary babe...", char = "gf", side = "middle", speed = 0.035},
    {text = "no hes not hes gay", char = "bf", side = "right", speed = 0.035},
    {text = "oh okay", char = "gf", side = "middle", speed = 0.035},
    {text = "now that u mentioned it im curious about your ex what happened to him", char = "bf", side = "right", speed = 0.035},
    {text = "he is not my ex he is a video game character", char = "gf", side = "middle", speed = 0.035},
    {text = "okay lets pay him a visit", char = "bf", side = "right", speed = 0.035},
    {text = "why in the world would you want to do that?", char = "gf", side = "middle", speed = 0.035}
}
