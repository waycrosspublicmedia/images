local dialogues = {
    {text = "whew! how lucky we are to have runned away from your big bad brother", char = "bf", side = "right", speed = 0.035},
    {text = "mhm", char = "gf", side = "middle", speed = 0.03},
    {text = "say.. where are we? it feels as if we have fallen into a deep cavern inside of an mountain..", char = "bf", side = "right", speed = 0.035},
    {text = "*how was it. how was the fall", char = "sans", side = "left", speed = 0.035},
    {text = "Hooooooooooooooooooooly fucking Shit", char = "gf", side = "middle", speed = 0.00001},
}
...
function onCreatePost()
    ...
    addAnimationByPrefix('char', 'sans', 'sans', 24, false)
