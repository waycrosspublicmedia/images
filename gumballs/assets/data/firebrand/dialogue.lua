local dialogues = {
    {text = "dude that was like, the fucking dude from undertale", char = "bf", side = "right", speed = 0.035},
    {text = "im shaking", char = "gf", side = "middle", speed = 0.035},
    {text = "stop that", char = "bf", side = "right", speed = 0.035},
    {text = "well well well... What do we got here..!", char = "tankman", side = "tank", speed = 0.035},
    {text = "ummm.. meow?", char = "bf", side = "right", speed = 0.035},
    {text = "Tank Man", char = "gf", side = "middle", speed = 0.035}
}
...
function onCreatePost()
    ...
    addAnimationByPrefix('char', 'tankman', 'tankman', 24, false)
