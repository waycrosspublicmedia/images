local dialogues = {
    {text = "well... THAT was awkward..!", char = "bf", side = "right", speed = 0.035},
    {text = "i told you Stupidhead", char = "gf", side = "middle", speed = 0.035},
    {text = "he's weird lookin", char = "bf", side = "right", speed = 0.035},
    {text = "be nice bro", char = "gf", side = "middle", speed = 0.035},
    {text = "hey now. who is this boy you brought with you", char = "bro", side = "bro", speed = 0.035},
    {text = "im boyfriend! From f", char = "bf", side = "right", speed = 0.035},
    {text = "boyfriend? heh. more like. bye friend.", char = "bro", side = "bro", speed = 0.035},
    {text = "stop ittt hes nice okk :( he can sing too", char = "gf", side = "middle", speed = 0.035},
    {text = "oh he thinks he can sing? well. then he better sing better than me. come on chump", char = "bro", side = "bro", speed = 0.035},
     {text = "please dont hurt me", char = "bf", side = "right", speed = 0.1}
}
...
function onCreatePost()
    ...
    addAnimationByPrefix('char', 'bro', 'bro', 24, false)
